...
namespace Juan_Diego_TallerMVC.Controllers
{
    public class BurgersController : Controller
    {
        private readonly Juan_Diego_TallerMVCContext _context;

        public BurgersController(Juan_Diego_TallerMVCContext context)
        {
            _context = context;
        }
